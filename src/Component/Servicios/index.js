...
import casaladdin from '../../resources/Casino_aladdin.jpg'
    ...
    return (
        <>
            <div className="img-head">
                <img className="img-cas" src={casaladdin} alt="casaladdin" />
            </div>
            <div>
                <center>
                    <h1 className="tittle-service italiana-regular">
                        Servicio y Maquinas a tú <br /> disposición
                    </h1>
                    <br />
                    ...
                    <div className="content-machin">
                        <div class="card">
                            <div class="image-container">
                                <img src={Maquina1} alt="Máquina tragamonedas" />
                            </div>
                            <div class="content">
                                <h2>{nombreMaq1}</h2>
                                <p>{DescriMaqui1}</p>
                ...
                <div className="divisionM">
                    ...
                    <h1 className="italiana-regular">Para sentirte mas comodo y seguir retando tu suerte</h1>
                </div>
                <br />
                <center>
                    <div className="content-machin">
